...
import talentData from "../../../content/pages/talent-acquisition-news.json";
...
export default function TalentAcquisitionNewsPage() {
  const sections: TalentSection[] = talentData.sections;
